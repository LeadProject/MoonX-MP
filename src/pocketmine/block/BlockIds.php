...
interface BlockIds{
	...
	public const STONECUTTER_BLOCK1 = 245;
	...
	public const SMOKER_BLOCK = 453;
	public const LIT_SMOKER = 454;
	public const CARTOGRAPHY_TABLE_BLOCK = 455;
	public const FLETCHING_TABLE_BLOCK = 456;
	public const SMITHING_TABLE_BLOCK = 457;
	public const BARREL_BLOCK = 458;
